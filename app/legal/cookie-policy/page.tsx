function CookiePolicy() {
  return (
    <div>
      <h1>Cookie Policy for Best Buyer</h1>

      <p>This is the Cookie Policy for Best Buyer, accessible from https://bestbuyer.in</p>
      ...
      <ul>
        <li>By visiting this link: https://www.bestbuyer.in/contact</li>
      </ul>
    </div>
  );
}
