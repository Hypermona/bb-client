    ...
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Best Buyer.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Best Buyer, accessible from{" "}
            <a href="https://www.bestbuyer.in" rel="external nofollow noopener" target="_blank">
              https://www.bestbuyer.in
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a href="www.bestbuyer.in/contact" rel="external nofollow noopener" target="_blank">
            www.bestbuyer.in/contact
          </a>
        </li>
      </ul>
    </div>
